            ...
            <div class="col-12 col-md-8">
                <div class="app-card app-card-settings shadow-sm p-4">
                    ...
                    <div class="app-card-body">
                        <form action="{{ route('departement.store') }}" class="settings-form" method="POST">
                            @csrf
                            @method('POST')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="setting-input-1" name="name" placeholder="Entre le nom" value="{{ old('name') }}"
                                    required>
                                    @error('name')
